    ...
    <div class="content-wrapper">
                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('admin_users.index')}}">User</a>
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="content-body">
            <section id="basic-vertical-layouts">
                <form class="form form-vertical" action="{{route('admin_users.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
